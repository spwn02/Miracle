...
The reference toolchain is developed in [`spwn02/clang-cxx26:cxx26`](https://github.com/spwn02/clang-cxx26/tree/cxx26) together with its matching libc++. The fork is synchronized with LLVM/Clang 22.1.8, and CI pins the immutable `cxx26-2026.09.25` snapshot. GCC compatibility is a deferred implementation concern and may trail `master`.
