...
- CMake 4.4 or newer
- Ninja
- [`spwn02/clang-cxx26:cxx26`](https://github.com/spwn02/clang-cxx26/tree/cxx26) and its matching libc++ as the reference implementation, pinned in CI to the immutable `cxx26-2026.09.25` snapshot.
